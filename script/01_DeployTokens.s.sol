...
// DemoToken
// =============================================================================
// Minimal mintable ERC20 used only for the SuperHook demo.
...
// 01_DeployTokens
// =============================================================================
// Deploys DEMO_A and DEMO_B ERC20 tokens to Unichain testnet and mints an
// initial supply to the deployer so they can seed the V4 pool with liquidity
// in the next stage.
//
// Usage:
//   forge script script/01_DeployTokens.s.sol \
//     --rpc-url $RPC_URL \
//     --broadcast \
//     --private-key $KEY \
//     -vvv
...
//   KEY   — deployer private key (also becomes the minter for both tokens)
//
// Outputs (log to console for use in subsequent scripts):
//   DEMO_A address
//   DEMO_B address
// =============================================================================
