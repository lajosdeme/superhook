...
abstract contract BaseSubHook is IHooks {
    ...
    function validateHookAddress(BaseSubHook _this) internal pure virtual {
    ...
    ) external onlySuperHook returns (bytes4) {
    ...
    function afterAddLiquidity(
        ...
        bytes calldata hookData
    ) external onlySuperHook returns (bytes4, BalanceDelta) {
    ...
    function afterSwap(
        ...
        BalanceDelta delta,
        bytes calldata hookData
    ) external onlySuperHook returns (bytes4, int128) {
